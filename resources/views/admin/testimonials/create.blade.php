...
@section('admin_content')
    <div style="margin-bottom: 30px;">
        ...
        <h2 style="color: var(--primary); font-weight: 800;">Add Testimonial</h2>
        <p style="color: #64748b; font-size: 14px;">Capture a new clinical success story or expert endorsement.</p>
    </div>
        ...
        <form action="/admin/testimonials" method="POST" enctype="multipart/form-data">
            ...
            <div style="display: flex; flex-direction: column; gap: 25px;">
                <div class="form-group">
                    ...
                    <input type="text" name="name" placeholder="e.g. Dr. Rajesh Patel" required style="width: 100%; padding: 15px 20px; border: 2px solid #eef2f6; border-radius: 12px; font-size: 15px;">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="role" placeholder="e.g. Senior Surgeon, Apollo Hospitals" style="width: 100%; padding: 15px 20px; border: 2px solid #eef2f6; border-radius: 12px; font-size: 15px;">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" rows="6" placeholder="Paste the client testimonial here..." required style="width: 100%; padding: 15px 20px; border: 2px solid #eef2f6; border-radius: 12px; font-size: 15px; font-family: inherit;"></textarea>
                </div>
                ...
                <button type="submit" class="btn btn-primary" style="width: 100%; padding: 20px; border-radius: 15px; font-weight: 800; font-size: 1rem; margin-top: 10px;">PUBLISH TESTIMONIAL</button>
            </div>
        </form>
    </div>
@endsection
